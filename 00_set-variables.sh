...
export VERSION=4.18.0-okd-scos.4  #Version List - https://github.com/okd-project/okd-scos/releases/
...
if [ $CLUSTER_NAME = 'okdlab' ]; then
    ...
    export PE_ENDPOINT=192.168.10.27
